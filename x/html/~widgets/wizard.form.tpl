...
{foreach $input as $i => $put}
	<!-- Build our Inputs. -->
	<!-- An Input should consits of a lable, icon, and name attribute. -->
	<!-- Upon Blur, the input should validate and save. -->
	<!-- The Icon Next to it, should change to indicate that it is saving. -->	
{/foreach}
